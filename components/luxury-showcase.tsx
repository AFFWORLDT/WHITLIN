    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <section className="relative h-[90vh] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            src="/PREMIUM.png"
            alt="KeraGold Premium Collection"
            fill
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center text-white max-w-6xl mx-auto px-6">
            ...
            <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-4xl mx-auto">
              Discover our exclusive collection of luxury hair care products. 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                size="lg" 
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-black font-bold px-8 py-4 text-lg"
