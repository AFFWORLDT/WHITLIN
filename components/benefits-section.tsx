        ...
        <ScrollAnimate animation="fade-in-up">
          <div className="text-center mb-12 md:mb-16">
            <div className="inline-block mb-4">
              <span className="text-[#e1d7c6] text-sm font-semibold uppercase tracking-wider">Why Choose Us</span>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-7xl mx-auto">
          {benefits.map((benefit, index) => (
            <ScrollAnimate 
              ...
              delay={index * 100}
            >
              <div className="bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-[#e5e5e5] hover:border-[#e1d7c6]/40 group hover-lift relative overflow-hidden h-full">
                <div className="absolute inset-0 bg-gradient-to-br from-[#e1d7c6]/0 via-[#e1d7c6]/0 to-[#e1d7c6]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#e1d7c6]/5 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-700" />
                <div className="relative z-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#e1d7c6]/20 via-[#e1d7c6]/10 to-[#e1d7c6]/5 rounded-2xl flex items-center justify-center mb-6 group-hover:from-[#e1d7c6]/30 group-hover:to-[#e1d7c6]/15 transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 shadow-lg group-hover:shadow-xl">
                    <benefit.icon className="w-8 h-8 text-[#e1d7c6] transition-transform duration-500 group-hover:scale-125" />
                  </div>
                  <h3 className="font-serif text-xl md:text-2xl font-bold mb-3 text-[#1a1a1a] group-hover:text-[#e1d7c6] transition-colors duration-300">
                    {benefit.title}
                  </h3>
                  <p className="text-[#404040] text-sm md:text-base leading-relaxed">
                    {benefit.description}
                  </p>
                </div>
              </div>
